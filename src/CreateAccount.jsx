...
/>
                ...
                <label className="block mt-4 text-sm">
                  ...
                  <input
  className="block p-2 w-full mt-1 text-sm border rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
  placeholder="***************"
  type="password"
/>
                </label>
